...
const isHealthRecord = require('../middlewares/isHealthRecord');

router.get('/doctor/newpatient', verifyToken, (req, res) => {
...
router.post('/login', async (req, res) => {
	try {
		...
		Originalpassword !== req.body.password && console.log('wrong credentials');
